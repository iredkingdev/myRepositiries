...
require 'db/connect.php';
    session_start();
    if(isset($_GET['page'])){
        $array_page = array('index_content', 'gallery', 'devilery', 'shop', 'busket', 'search_shop', 'registration');
...
<body>
                ...
                <section class="header_navigation">
                    ...
                    <nav>
                        <ul>
                            ...
                            <li><a href="adminpanel.php">Контакты</a></li>
                            <li><a href="index.php?page=busket">Корзина</a></li>
                            <li><?php
                                if($_SESSION['login'] && $_SESSION['password']){
                                    echo "<a href='php_handler/exit_to_autor.php'>Выйти из ".$_SESSION['login']."</a>";
                                }else{
                                    echo "<a href='index.php?page=registration'>Войти</a>";
                                }
    ...
    <script>
        ...
        for(let i = 0; i < all_input.length; i++ ){
            ...
            all_input[i].addEventListener('click', function(e){
