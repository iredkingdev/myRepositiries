<?php
    ...
    require 'db/db.php';
    if(isset($_GET['page'])){
        $array_pages = array('about','catalog','work','contact', 'policy', 'admin_enter');
...
<body>
                ...
                <section class="navigation">
                    <nav class="header-nav">
                        ...
                        <ul class="header-ul">
                            ...
                            <li>
                                <a href="index.php?page=admin_enter" class="icon-settings setting"></a>
                            </li>
    ...
    <script>
        let get_class_value_img = document.getElementById('download_image');
        let get_class_download_image = document.querySelector('.download_image');
        
        
        //console.log(get_child_node_value_img);

        
        get_class_value_img.addEventListener('change', change_file)
        function change_file(){
            if(this.value){
                console.log("Файл выбран");
                document.querySelector('.info').innerText = "Файл выбран и готов к загрузке";
            }
        }
